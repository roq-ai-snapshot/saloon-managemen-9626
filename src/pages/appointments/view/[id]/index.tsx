            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Appointment Guest Id Touser"
                    text={
                      <Link as={NextLink} href={`/users/view/${data?.user_appointment_guest_idTouser?.id}`}>
                        {data?.user_appointment_guest_idTouser?.email}
                      </Link>
                    }
                  />
                )}
                ...
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Appointment Staff Id Touser"
                    text={
                      <Link as={NextLink} href={`/users/view/${data?.user_appointment_staff_idTouser?.id}`}>
                        {data?.user_appointment_staff_idTouser?.email}
                      </Link>
                    }
                  />
                )}
