...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`saloon management application`}</title>

        <meta
          name="description"
          content="Welcome to Saloon Management Application - Streamlining your business operations for ultimate efficiency and customer satisfaction."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1485686531765-ba63b07845a7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzYWxvb258ZW58MHx8fHwxNjkzMjA2NTEyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@danteov_seen?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Nikola Jovanovic`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Saloon Management Application - Streamlining your business operations for ultimate efficiency and customer satisfaction.`}
            </Text>
            <Box
