...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create': { roles: ['staff-member'], key: 'task-assigned', tenantPath: ['organization', 'task'], userPath: [] },
  'task.update': { roles: ['manager'], key: 'task-status-update', tenantPath: ['organization', 'task'], userPath: [] },
  'appointment.create': {
    roles: ['owner', 'manager'],
    key: 'new-appointment',
  ...
  'transaction.create': {
    roles: ['accountant'],
    key: 'new-transaction',
    tenantPath: ['organization', 'transaction'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'manager', 'staff-member', 'accountant'];
